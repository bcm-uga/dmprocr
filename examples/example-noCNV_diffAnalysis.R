### perform DE analysis on individuals with no cnv variation (be careful to use normalized count data as input)
...
### you can change the filter on CNV (considere no cnv variation of cnv values between -0.3 and 0.3) 
